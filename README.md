...
I'm super enthusiastic, detail-oriented, and always striving to learn and grow. To support a move into tech, I have completed a Data Analytics Level 4, a machine learning bootcamp, Advanced GA4, Salesforce, and AWS Cloud Practitioner, and I apply those skills in the projects you’ll find here: analytics, forecasting, and experimentation aimed at better commercial decisions.

I am open to SaaS sales roles across BDR/BDM, Account Executive, and GTM‑focused positions where I can combine strong sales execution with analytics‑driven pipeline and performance management. You can <a href="mailto:yuliavk.git@gmail.com?subject=[GitHub]">reach out</a> or on connect with me on [LinkedIn](https://www.linkedin.com/in/yuliavk/).
...
(London Neighbourhood Safety Prediction <!--(https://github.com/mlsystemdesignproject/neighbourhood-safety-prediction#readme)-- Project)
